...
public class BatteryMonitorObject extends GuiObject{
	...
	public BatteryMonitorObject(NativeFunctions nf, float x, float y, boolean visable, TextureRegion t, TextureRegion filler, TextureRegion charger) {
		super(x, y, visable, t);
		Filler = filler;
		Charger = charger;
		NF = nf;
